...
import classes from './PreventativeMaintenance.module.scss';
import { elements } from './PreventativeMaintenance.map';
import VIcon from 'components/VIcon/VIcon';

type Props = {};

const PreventativeMaintenanceView: React.FC<Props> = (props: Props) => {
  return (
    <div className={classes['container']}>
      <Image src={photo} alt={''} />
      <p className={classes['title']}>Preventative Maintenance</p>
...
export default PreventativeMaintenanceView;
